      ...
      <div className="relative min-h-screen">
        ...
        <div className="relative flex flex-col items-center pt-8 px-6 text-center">
          ...
          <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center mb-4">
            <span className="text-emerald-800 font-semibold text-lg">MAGPPIE</span>
          </div>

          {/* Title */}
          <h1 className="text-3xl font-semibold text-white mb-2">Wellness Kitchen</h1>

          {/* Subtitle */}
          <p className="text-white/90 text-lg">welcome to the wellness movement</p>
        </div>
      </div>
    </MobileLayout>
      Hello, world!

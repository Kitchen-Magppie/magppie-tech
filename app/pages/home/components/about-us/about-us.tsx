...
export function AboutUs() {
  return (
    <div className='flex flex-col items-center px-4 py-6 mt-6'>
      <h2 className='text-3xl font-semibold x-font-noto-serif-display-600-italic text-center mb-5'>
        About us
      </h2>
      <p className='text-md text-center text-gray-600 mb-4  x-font-barlow-semi-condensed-500'>
        the wellness vision
      </p>
      ...
      <div className='w-full max-w-md mt-4 overflow-hidden rounded-xl'>
        <div className='relative'>
          ...
          <div className='absolute inset-0 flex flex-col items-center justify-center bg-black bg-opacity-40 text-white px-4 text-center'>
            <h3 className='text-4xl font-bold mb-2 x-font-noto-serif-display-200-italic'>
              your health is your power
            </h3>
            <p className='text-base mt-5 x-font-barlow-semi-condensed-300'>
              our kitchens would keep it safe
            </p>
          </div>
        </div>
        <div className='bg-[#7C8562] text-white text-sm p-4 x-font-barlow-semi-condensed-300-italic'>
